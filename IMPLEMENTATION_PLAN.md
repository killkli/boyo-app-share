...
- [x] 在導航列添加「個人中心」連結 (2025-12-10)
- [x] 在 App 詳情頁顯示創作者資訊 (2025-12-10)
- [ ] 考慮添加創作者頭像或連結功能

### ✅ 導航與內容顯示完成 (2025-12-10)
- **個人中心首頁** (`pages/profile/index.vue`):
  - 建立個人中心入口頁面
  - 提供導航到「我的作品」和「我的收藏」
  - 顯示使用者資訊卡片
  - 遵循 Brutalist 設計風格

- **導航列更新** (`layouts/default.vue`):
  - 桌面版導航：添加「個人中心」連結（僅登入用戶可見）
  - 移動版菜單：添加「個人中心」連結（僅登入用戶可見）
  - 連結到 `/profile` 路由

- **App 詳情頁更新** (`pages/app/[id].vue`):
  - 顯示多個創作者（如果有 `creators` 欄位）
  - 創作者列表顯示頭像和排序
  - 向後相容：沒有創作者時顯示原始上傳者
  - 動態標題：「創作者」或「作者」

- **測試**:
  - ✅ 新增 creators 欄位測試（2 個測試通過）
  - ✅ API 正確返回 creators 陣列
  - ✅ 空 creators 時返回空陣列
  - ✅ 總計 225/226 測試通過
